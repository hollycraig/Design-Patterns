...
class BallPit {
    ...
    BallPit(double width, double height) {
        this.height = height;
        this.width = width;
        BallStrategy red = new StrategyRed();
        BallStrategy blue = new StrategyBlue();
        BallStrategy black = new StrategyBlack();
        balls.add(new Ball(100, 100, 20, Paint.valueOf("RED"), red));
        balls.add(new Ball(200, 200, 20, Paint.valueOf("BLACK"), black));
        balls.add(new Ball(300, 300, 20, Paint.valueOf("BLUE"), blue));
    }
...
//                    System.out.println("collided");
                    ...
                    didCollide = true;
                    //ball.think(balls, true, height, width, hitWall);
                }

                ball.think(balls, didCollide, height, width, hitWall);
                didCollide = false;
            }
            //TODO: modify think method to include in ball bit
